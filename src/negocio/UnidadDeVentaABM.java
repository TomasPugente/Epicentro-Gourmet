...
public class UnidadDeVentaABM {
	...
	public int agregarFoodTruck(String nombreComercial, float superficie, int codigo, float sueldoBase, Festival festival,float costoPorSuperficie, String patente, float usoElectricidad) {
